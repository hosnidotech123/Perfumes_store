  ...
  return (
    <div className='bg-white hover:shadow-2xl min-h-24 p-4 w-full h-auto transition-all duration-200 ease-in-out rounded-lg '>
      <div className='w-full h-[300px] mb-2'>
        <img className='w-full h-full object-cover rounded-lg' src="https://images.pexels.com/photos/12580617/pexels-photo-12580617.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="" />
      </div>
